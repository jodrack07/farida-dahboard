  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Farida | Details de l&apos;entreprise</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Entreprise" breadcrumbItem="Details" />
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <div className="text-muted">
                            <h5 className="font-size-16 mb-1">SOCIETE XYZ</h5>
                            <p className="mb-0">
                              Cette societe a été crée en 202 et est spécialisée
                              dans le domaine de la vente de produits
                              alimentaires et de boissons mais cela de maniere
                              digitales
                            </p>
                          </div>
                        </div>
                    ...
                    <Col lg={5}>
                      <div className="mt-3">
                        <ul className="text-muted ps-4">
                          <li className="py-1">
                            Site web : societexyz@gmail.com
                          </li>
                          <li className="py-1">Telephone : +243 888 888 888</li>
                          <li className="py-1">Email : www.societexyz.com</li>
                        </ul>
                      </div>
                    </Col>
                        ...
                        <Col lg={4} sm={6}>
                          <div className="d-flex align-items-center mt-4">
                            ...
                            <div className="flex-grow-1">
                              ...
                              <p className="text-muted mb-0">20 Fevrier 2022</p>
                            </div>
                          </div>
                        </Col>
                        ...
                        <Col lg={4} sm={6}>
                          <div className="d-flex align-items-center mt-4">
                            ...
                            <div className="flex-grow-1">
                              ...
                              <p className="text-muted mb-0">30 May, 2022</p>
                            </div>
                          </div>
                        </Col>
                      </Row>
